...
return {
    ...
    KC = function(palette)
        return {
            ...
            syn = {
                string     = palette.leaves,
                variable   = "none",
                number     = palette.earth,
                constant   = palette.shield,
                identifier = palette.leaves,
                parameter  = palette.moss,
                fun        = palette.sky,
                statement  = palette.shield,
                keyword    = palette.flower,
                operator   = palette.earth,
                preproc    = palette.flower,
                type       = palette.sky,
                regex      = palette.shield,
                deprecated = palette.katanaGray,
                punct      = palette.dragonGray2,
                comment    = palette.dragonAsh,
                special1   = palette.earth,
                special2   = palette.flower,
