    ...
    KC = function(palette)
        return {
            ui = {
                ...
                bg_search  = palette.flower,
                bg_visual  = palette.flower,
            ...
            syn = {
                string     = palette.color3,
                variable   = "none",
                number     = palette.color1,
                constant   = palette.color2,
                identifier = palette.color3,
                parameter  = palette.color4,
                fun        = palette.color5,
                statement  = palette.color6,
                keyword    = palette.color7,
                operator   = palette.color8,
                preproc    = palette.color9,
                type       = palette.color10,
                regex      = palette.color11,
                deprecated = palette.color12,
                punct      = palette.color13,
                comment    = palette.color14,
                special1   = palette.color1,
                special2   = palette.color3,
                special3   = palette.moss,
            },
            diag = {
                error   = palette.samuraiRed,
                ok      = palette.springGreen,
